...
public:
  ...
  uint64_t local_read_commit_counts_ = 0;
  uint64_t local_upsert_commit_counts_ = 0;
  uint64_t local_delete_commit_counts_ = 0;
  uint64_t local_range_commit_counts_ = 0;

  uint64_t local_abort_by_read = 0;
  uint64_t local_abort_by_upsert = 0;
  uint64_t local_abort_by_delete = 0;
  uint64_t local_abort_by_range = 0;

  uint64_t local_abort_by_read_validation = 0;
  uint64_t local_abort_by_node_validation = 0;
  uint64_t local_abort_by_tuple_wait_die = 0;
  uint64_t local_abort_by_node_wait_die = 0;
  ...
  uint64_t total_read_commit_counts_ = 0;
  uint64_t total_upsert_commit_counts_ = 0;
  uint64_t total_delete_commit_counts_ = 0;
  uint64_t total_range_commit_counts_ = 0;

  uint64_t total_read_abort_counts_ = 0;
  uint64_t total_upsert_abort_counts_ = 0;
  uint64_t total_delete_abort_counts_ = 0;
  uint64_t total_range_abort_counts_ = 0;

  uint64_t total_abort_by_read_validation = 0;
  uint64_t total_abort_by_node_validation = 0;
  uint64_t total_abort_by_tuple_wait_die = 0;
  uint64_t total_abort_by_node_wait_die = 0;
...
#endif
  void displayCommitAbortCount(size_t thread_num);

  void displayTpsAndAbortRatio(size_t extime, size_t thread_num);

  void displayTpsAndAbortRatioPerOps(size_t extime, size_t thread_num);

  void displayCommitCountPerOps();

  void displayCauseOfAbort();
  ...
  void addLocalReadCommitCounts(const uint64_t count);
  void addLocalUpsertCommitCounts(const uint64_t count);
  void addLocalDeleteCommitCounts(const uint64_t count);
  void addLocalRangeCommitCounts(const uint64_t count);

  void addLocalReadAbortCounts(const uint64_t count);
  void addLocalUpsertAbortCounts(const uint64_t count);
  void addLocalDeleteAbortCounts(const uint64_t count);
  void addLocalRangeAbortCounts(const uint64_t count);

  void addLocalAbortByReadValidation(const uint64_t count);
  void addLocalAbortByNodeValidation(const uint64_t count);
  void addLocalAbortByTupleWaitDie(const uint64_t count);
  void addLocalAbortByNodeWaitDie(const uint64_t count);
